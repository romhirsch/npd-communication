...
from models.polar_models import PolarSCL5GDecoder, SCTrellisDecoder, SCLsionnaDecoder
...
for code_rate in code_rates:
    ...
    ber_plot128.simulate(model, # the function have defined previously
                         ...
                         num_target_block_errors=30, # continue with next SNR point after 1000 bit errors
